    ...
    <div className='info-container'>
      <div className='info-inner-container'>
        ...
        <p className='info-para'>
          ...
          similar way to user input. This chat bot was created using React for
          the frontend and using IBM Watson Assistant for the language
          processing. It also utilises, Node-Red for flow mapping.
        </p>
      </div>
    </div>
  );
